...
export default function Index() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 flex items-center justify-center overflow-hidden relative">
      ...
      <div className="text-center space-y-16 px-8 relative z-10">
        <div className={`transition-all duration-1000 ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}>
          <div className="bg-gradient-to-br from-white to-indigo-50 rounded-3xl shadow-xl border border-indigo-200/50 p-12 mb-16 backdrop-blur-sm">
            <img src="/logo-black.png" alt="서대문농아인복지관" className="h-24 mx-auto mb-8 filter drop-shadow-lg" />
            <div className="h-1 bg-gradient-to-r from-blue-400 via-purple-400 to-pink-400 w-32 mx-auto rounded-full"></div>
          </div>
          <h1 className="text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 mb-6 tracking-tight drop-shadow-sm">
            지화 명함 만들기
          </h1>
          <p className="text-2xl text-slate-700 font-medium leading-relaxed max-w-2xl mx-auto">
            손끝으로 전하는 마음,<br/>
            <span className="text-purple-600 font-semibold">나만의 특별한 수어 명함</span>을 만들어보세요
          </p>
        </div>
